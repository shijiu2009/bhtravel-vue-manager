  ...
  <div>
    ...
    <div class="data_list">
      ...
      >
        ...
        <el-table-column prop="longitude" label="经度" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="latitude" label="纬度" align="center" show-overflow-tooltip></el-table-column>
...
export default {
  ...
  methods: {
    ...
    editLinkBtn: function (id) {
      let path = "addServiceInformation";
      if (id) {
        path = "editServiceInformation";
      }
    ...
    getList: function () {
      ...
      api
        ...
        .then((result) => {
          ...
          this.serviceInformationList = result.rows;
