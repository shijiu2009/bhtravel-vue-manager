  ...
  <div>
    ...
    <div class="data_list">
      ...
      >
        ...
        <el-table-column prop="name" label="旅行社名称" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="score" label="诚信分" align="center" show-overflow-tooltip></el-table-column>
