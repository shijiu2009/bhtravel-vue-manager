  ...
  <div>
    ...
    <div class="data_list">
      ...
      >
        ...
        <el-table-column prop="name" label="场所名称" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="createTime" label="创建时间" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column label="是否开放" width="60" align="center">
        ...
        <el-table-column label="所属类型" align="center" show-overflow-tooltip>
          <template slot-scope="scope">
            <el-tag
              type="primary"
              disable-transitions
            >{{scope.row.type=="0"?"科技馆":scope.row.ctype=="1"?"博物馆":scope.row.ctype=="2"?"展览馆":"其他"}}</el-tag>
          </template>
        </el-table-column>
