      ...
      <el-form ref="form" :model="info" label-width="90px">
        <div class="form_item">
          ...
          <el-row>
            ...
            <UploadFile @uploadValue="thumbValue" :uploadGroup="uploadGroupThumb"></UploadFile>
          </el-row>
          <el-row>
            <el-col :span="3">
          ...
          <el-row>
            ...
            <UploadFile @uploadValue="headImgValue" :uploadGroup="uploadGroupHeadImg"></UploadFile>
          </el-row>
