      ...
      <el-form ref="form" :model="commentInfo" label-width="108px">
        <div class="form_item">
          <el-form-item label="评论对象类别" :required="true">
            <el-select v-model="commentInfo.type" reserve-keyword clearable placeholder="请选择">
              <el-option
          ...
          <el-form-item label="星级" :required="true">
            <el-select v-model="commentInfo.star" reserve-keyword clearable placeholder="请选择">
              <el-option
          ...
          <el-form-item label="审核" :required="true">
            <el-select v-model="commentInfo.reviewed" reserve-keyword clearable placeholder="请选择">
              <el-option
          ...
          <el-form-item label="评论内容" :required="true">
            <el-input type="textarea" rows="10" maxlength="255" v-model="commentInfo.content"></el-input>
          </el-form-item>
          <el-form-item label="回复内容" :required="true">
            <el-input type="textarea" rows="10" maxlength="255" v-model="commentInfo.replyContent"></el-input>
          </el-form-item>
        </div>
        <!-- 操作按钮 -->
        <el-form-item>
  ...
  methods: {
    ...
    getComment: function () {
      ...
      if (this.$route.params && this.$route.params.id) {
        ...
        //重置参数
        Object.keys(this.commentInfo).map(
          (key) => (this.commentInfo[key] = "")
        );
