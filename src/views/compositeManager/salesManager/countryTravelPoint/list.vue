  ...
  <div>
    ...
    <div class="data_list">
      ...
      >
        ...
        <el-table-column prop="ctName" label="所属农家乐" width="150" align="center" show-overflow-tooltip></el-table-column>
...
export default {
  name: "countryTravelPointList",
  data() {
    return {
      //加载
      loading: true,
      countryTravelPointList: [],
  ...
  methods: {
    ...
    openDeleteWarning: function (index, id) {
      this.$confirm("此操作将永久删除该数据么, 是否继续?", "提示", {
        ...
        .then(() => {
          //在列表中删除数据
          return countryTravelPointApi.deleted({ ids: id });
        })
        .then(() => {
          this.getList();
          this.$message({
    ...
    getList: function () {
      ...
      countryTravelPointApi
        ...
        .then((result) => {
          ...
          this.countryTravelPointList = result.rows;
