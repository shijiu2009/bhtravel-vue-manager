  ...
  <div>
    ...
    <div class="data_list">
      ...
      >
        ...
        <el-table-column prop="user" label="咨询人昵称" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="content" label="咨询内容" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="createtime" label="咨询时间" align="center" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column prop="replyname" label="回复人" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="reply" label="咨询回复" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="replytime" label="回复时间" align="center" show-overflow-tooltip></el-table-column>
    ...
    getList: function () {
      ...
      api
        ...
        .then((result) => {
          ...
          this.complaintList = result.rows;
