...
<script>
import api from "@/api/reserveManager/homestay.js";
      ...
      if (this.$route.params && this.$route.params.id) {
        api
          ...
          .then((result) => {
            ...
            if (result.homestay.icon != null && result.homestay.icon != "") {
              this.uploadGroupThumb.fileList.push({
                url: baseURL.releaseUrl + result.homestay.icon,
              });
            }
