      ...
      if (this.$route.params && this.$route.params.id) {
        ...
        activityApi
          ...
          .then((result) => {
            ...
            this.info = JSON.parse(JSON.stringify(result.activity));
            if (result.activity.titleImg != null && result.activity.titleImg != "") {
              this.uploadGroupTitle.fileList.push({
                url: baseURL.releaseUrl + result.activity.titleImg,
              });
            }
