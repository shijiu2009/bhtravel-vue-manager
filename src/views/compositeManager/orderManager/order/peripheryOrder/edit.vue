      ...
      <el-form ref="form" :model="info" label-width="90px">
        <div class="form_item">
          <el-card class="box-card">
            ...
            <div class="text item">线路名称： {{ info.title }}</div>
            <div class="text item">预定出行时间： {{ info.schedule }}</div>
          ...
          <el-form-item v-if="info.refund == -1" label="拒绝退款理由">
...
<script>
import api from "@/api/reserveManager/peripheryOrder.js";
import { mapMutations } from "vuex";
export default {
  components: {},
  name: "editPeripheryOrder",
  data() {
    return {
      info: {
        id: "",
