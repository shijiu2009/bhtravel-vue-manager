  ...
  <div>
    ...
    <div class="data_list">
      ...
      >
        ...
        <el-table-column label="是否下架" width="60" align="center">
          <template slot-scope="scope" >
            <el-tag
        ...
        <el-table-column prop="className" label="分类名称" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column label="是否下架" width="60" align="center">
          <template slot-scope="scope" >
            <el-tag
              :type="scope.row.down=='1' ? 'success' : 'primary'"
