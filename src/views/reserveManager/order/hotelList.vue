  ...
  <div>
    <div class="data_list">
      ...
      >
        ...
        <el-table-column prop="hotelName" label="酒店名称" align="center" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column prop="startDate" label="入住日期" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="endDate" label="离店日期" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="dayPrice" label="每日价格" align="center" show-overflow-tooltip></el-table-column>
