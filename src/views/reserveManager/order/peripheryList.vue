  ...
  <div>
    <div class="data_list">
      ...
      >
        ...
        <el-table-column prop="title" label="线路" align="center" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column prop="schedule" label="预定出行时间" align="center" show-overflow-tooltip></el-table-column>
    ...
    getList: function () {
      ...
      api
        ...
        .then((result) => {
          ...
          this.peripheryList = result.rows;
