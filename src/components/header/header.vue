          ...
          <div class="btn-bell header-btn">
            ...
            >
              <router-link to="/">
                ...
                <span style="font-size:14px;color:#fff;margin-left:-6px;margin-right:8px">消息</span>
              </router-link>
            </el-tooltip>
            <span class="btn-bell-badge" v-if="message"></span>
          </div>
          <!-- 用户头像及下拉菜单 -->
          <el-dropdown class="user-avator" trigger="hover" @command="handleCommand">
           <img class="right-userimg" :src="userimage" alt="">
